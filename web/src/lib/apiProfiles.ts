...
export function normalizeSettings(input: Partial<AppSettings> | unknown): AppSettings {
  ...
  return {
    ...
    imageflowManagedMode: typeof record.imageflowManagedMode === 'boolean' ? record.imageflowManagedMode : false,
    imageflowApiBaseUrl: typeof record.imageflowApiBaseUrl === 'string' && record.imageflowApiBaseUrl.trim() ? record.imageflowApiBaseUrl.trim() : 'http://localhost:8081',
    imageflowApiKey: typeof record.imageflowApiKey === 'string' ? record.imageflowApiKey : '',
    imageflowBasicUsername: typeof record.imageflowBasicUsername === 'string' ? record.imageflowBasicUsername : '',
    imageflowBasicPassword: typeof record.imageflowBasicPassword === 'string' ? record.imageflowBasicPassword : '',
    imageflowWorkspaceId: typeof record.imageflowWorkspaceId === 'string' && record.imageflowWorkspaceId.trim() ? record.imageflowWorkspaceId.trim() : 'ws_default',
    imageflowProjectId: typeof record.imageflowProjectId === 'string' && record.imageflowProjectId.trim() ? record.imageflowProjectId.trim() : 'prj_xhs_anime',
...
export const DEFAULT_SETTINGS: AppSettings = normalizeSettings({
  ...
  imageflowManagedMode: false,
  imageflowApiBaseUrl: 'http://localhost:8081',
  imageflowApiKey: '',
  imageflowBasicUsername: '',
  imageflowBasicPassword: '',
  imageflowWorkspaceId: 'ws_default',
  imageflowProjectId: 'prj_xhs_anime',
