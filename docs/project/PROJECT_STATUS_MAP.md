...
| 后续 P1 | Server Deployment Rehearsal | 真实服务器/NAS 拉取 GHCR 镜像、配置 HTTPS 反代、跑 mock smoke、验证备份和回滚 | 准备包已完成：`issues/next-phase-p1-server-deployment-rehearsal.csv` 与 `slice-053` 已新增；真实服务器执行待做 |
