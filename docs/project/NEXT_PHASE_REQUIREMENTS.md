...
5. Safe Delete 产品化：CLI + Admin-only REST foundation、Web 当前 campaign 清理入口和单 asset archive/restore 已完成；archived 默认不进 cleanup；下一步补 task/input-file reset、browser smoke 和生产备份演练。
